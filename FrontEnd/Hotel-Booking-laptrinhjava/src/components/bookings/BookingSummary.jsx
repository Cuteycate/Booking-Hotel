...
const BookingSummary = ({roomId, booking, payment, isFormValid, onConfirm }) => {
	...
	const handleConfirmBooking = async () => {
		try {
			...
			const returnUrl = `${window.location.origin}/booking-success?roomId=${roomId}&guestFullName=${encodedGuestFullName}&guestEmail=${booking.guestEmail}&checkInDate=${booking.checkInDate}&checkOutDate=${booking.checkOutDate}&numOfAdults=${booking.numOfAdults}&numOfChildren=${booking.numofChildren}`;
